    ...
    <div style={{ animation: 'fadeUp .25s both' }}>
      {uiV2 ? (
        <PageHeader
          ...
          action={
            botOn ? <Badge tone="success">Ao vivo</Badge> : <Badge tone="warning">Pausado</Badge>
          }
        />
      ) : null}
      ...
      {typing ? (
        <Card muted style={{ marginBottom: 8, borderColor: 'rgba(34, 120, 166, 0.24)' }}>
          <div
            style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 12, color: C.info }}
          >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      <div>
                        ...
                        <div style={{ marginTop: 1, fontSize: 11, color: C.text2 }}>
                          {message.group}
                        </div>
                      </div>
